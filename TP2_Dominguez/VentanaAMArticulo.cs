...
{
    public partial class VentanaAMArticulo : Form
    {

        private Articulo articulo = null;
        public VentanaAMArticulo()
        {
            InitializeComponent();
        }

        public VentanaAMArticulo(Articulo articulo)
        {
            InitializeComponent();
        ...
        private void VentanaAMArticulo_Load(object sender, EventArgs e)
        {
